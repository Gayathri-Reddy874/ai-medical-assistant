...
<!-- Replace these filenames with the actual images inside your /Screenshots folder -->

| Upload & Index | Chat / Q&A |
|---|---|
| ![Upload screen](Screenshots/upload.png) | ![Chat screen](Screenshots/chat.png) |
